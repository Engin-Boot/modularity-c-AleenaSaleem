...
namespace ColorCode
{
    class TestsForColorCoder
    {
        ...
        {
            int pairNumber = 4;
            ColorCode.ColorPair testPair1 = ColorCode.GetColorFromPairNumber(pairNumber);
            ...
            ColorCode.ColorPair testPair2 = new ColorPair() { majorColor = Color.Yellow, minorColor = Color.Green };
